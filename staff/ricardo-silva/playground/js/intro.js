...
alumnos[4] = {nombre: 'Paula', edad: 32, series: ['Breaking Bad','The Boys','Attack of Titans']}
alumnos[5] = {nombre: 'Manuel', edad: 15, series: []}
alumnos[6] = {nombre: 'Jorge', edad: 32, series: ['The Office','One Piece','Ted Lasso']}
alumnos[7] = {nombre: 'Sergio', edad: 30, series: ['Pose','Attack of Titans','Severance']}
alumnos[8] = {nombre: 'Rodolfo', edad: 36, series: ['Fringe','How I met your mother']}
alumnos[9] = {nombre: 'Stephany', edad: 27, series: ['Greys Anatomy','House of Dragon','Friends']}
alumnos[10] = {nombre: 'Agustin', edad: 23, series: ['Sobrenatural','Perdidos','Majime no ippo']}
alumnos[11] = {nombre: 'Patricia', edad: 23, series: ['Girls','Sex and the City','The Handmind fale']}
alumnos[12] = {nombre: 'Ibra', edad: 18, series: ['Luppin']}
